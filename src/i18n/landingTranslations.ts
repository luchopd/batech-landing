...
const ES: Dict = {
  ...
  "contact.form.error": "Hubo un problema al enviar. Intenta de nuevo o escríbenos a lp@batech.ai",
...
const EN: Dict = {
  ...
  "contact.form.error": "Something went wrong. Please try again or email lp@batech.ai",
...
const PT: Dict = {
  ...
  "contact.form.submit": "Solicitar demo →",
  "contact.form.submitting": "Enviando…",
  "contact.form.error": "Houve um problema ao enviar. Tente novamente ou escreva para lp@batech.ai",
